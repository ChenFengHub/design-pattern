...
public class AliPayCallbackTemplate extends AbstractPayCallbackTemplate {
    ...
    protected Map<String, String> verifySignature() {
        ...
        // 支付宝支付订单号
        verifySignature.put("aliPayOrderNumber", "20000000001");
        // 假数据，模拟银联回调报文 end
    ...
    protected String asyncService(Map<String, String> verifySignature) {
        log.info(">>>第三步 支付宝 asyncService，verifySignature：{}", verifySignature);
        ...
        if ("1".equals(paymentStatus)) {
            ...
            log.info(">>> orderNum:{}，支付宝已经支付成功，修改订单的状态为已支付。。。", aliPayOrderNumber);
